							...
							<div class="info-8 info">
								...
								<div class="more-info-wrap">
									...
									<ul>
										...
										<li>Комплексная реабилитация пациентов с использовванием артик уляционной диагностики и лицевой дуги</li>
										...
										<li>Изготовление вкладок inlay, onlay</li>
										<li>Изготовление штифтовых конструкций</li>
										<li>Изготовление металлокерамических коронок и мостовидных протезов</li>
									</ul>
								</div><!-- .more-info -->
							</div><!-- .info -->
						</div><!-- .col-lg-2 col -->
