					...
					<div class="cols-wrap">
						...
						<div class="col-9 col js-auto-height">
							...
							<div class="info-9 info">
								...
								<div class="more-info-wrap">
									<span>Стоматолог-ортопед. Опыт работы - более 16 лет. Действительный член ассоциации стоматологов Украины.</span>
									<div class="list-ttl">
										Специализация виды деятельности:
									</div><!-- .list-ttl -->
									<ul>
										<li>Полный терапевтический приём</li>
										<li>Оказание ортопедической помощи в виде несъемных конструкций</li>
										<li>Съемное протезирование разной степени сложности</li>
										<li>Хирургический прием в пределах амбулаторного</li>
										<li>Ведение детского приема при условии адекватности пациента</li>
									</ul>
								</div><!-- .more-info -->
							</div><!-- .info -->
						</div><!-- .col-lg-2 col -->
						<div class="col-10 col js-auto-height">
							...
							<div class="info-10 info">
								...
								<div class="more-info-wrap">
									<span>Врач стоматолог-гигиенист. Действительный член ассоциации стоматологов Украины. Опыт работы 5 лет.</span>
									<div class="list-ttl">
										Виды деятельности:
									</div><!-- .list-ttl -->
									<ul>
